...
// PT_* macros are defined instead so we can use that.
    ...
    DO_STRINGIFY(PT_READ_I)
    DO_STRINGIFY(PT_READ_D)
    DO_STRINGIFY(PT_WRITE_I)
    DO_STRINGIFY(PT_WRITE_D)
    DO_STRINGIFY(PT_IO)
    DO_STRINGIFY(PT_LWPINFO)
    DO_STRINGIFY(PT_GETNUMLWPS)
    DO_STRINGIFY(PT_GETLWPLIST)
    DO_STRINGIFY(PT_CLEARSTEP)
    DO_STRINGIFY(PT_SUSPEND)
    DO_STRINGIFY(PT_RESUME)
    DO_STRINGIFY(PT_TO_SCE)
    DO_STRINGIFY(PT_TO_SCX)
    DO_STRINGIFY(PT_FOLLOW_FORK)
#if defined(PT_LWP_EVENTS)
    DO_STRINGIFY(PT_LWP_EVENTS)
#endif
    DO_STRINGIFY(PT_GETREGS)
    DO_STRINGIFY(PT_SETREGS)
    DO_STRINGIFY(PT_GETFPREGS)
    DO_STRINGIFY(PT_SETFPREGS)
    DO_STRINGIFY(PT_GETDBREGS)
    DO_STRINGIFY(PT_SETDBREGS)
    DO_STRINGIFY(PT_VM_TIMESTAMP)
    DO_STRINGIFY(PT_VM_ENTRY)
#endif
